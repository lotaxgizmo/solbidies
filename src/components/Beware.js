...
function Beware() {
    return (
        <div className='relative flex flex-col items-center bg-black py-10'>
            {/* <img src={beware} alt="" className='mb-10' /> */}

            <img src={tophero} alt="" className='mt-32 lg:mt-24 w-[1019px] z-[3]' />
            <img src={maingif} alt="" className='absolute pb-5 lg:mb-1 mt-[-s130px]- w-[430px] lg:w-[630px] z-[3] top-52 lg:bottom-10' />
